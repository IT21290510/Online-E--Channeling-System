...
<Body>
    ...
    <center>
        <table border="2" align="center" style="width: 50%; border-color: black;">
            <tr><th><br>
                <a class="Select_btn btn1" onclick="window.location.href='#'" type="button">Patient Login</a><br><br>
                <a class="Select_btn btn1" onclick="window.location.href='#'" type="button">Doctor Login</a><br><br>
				<a class="Select_btn btn1" onclick="window.location.href='Rlogin.jsp'" type="button">Receptionist Login</a><br><br>
                <a class="Select_btn btn1" onclick="window.location.href='#'" type="button">Admin Login</a><br><br>
